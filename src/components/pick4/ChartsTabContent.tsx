...
import { Pick4Chart } from '@/components/charts/Pick4Chart';
  ...
  return (
    <>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mb-6">
        ...
        <label htmlFor="chart-width-slider-p4" className="text-sm mb-2 block">Adjust Chart Width (%)</label>
        <div className="flex items-center gap-4">
          <span className="text-xs">20</span>
          <input
            id="chart-width-slider-p4"
            type="range"
            value={chartWidth[0]}
...
export function Pick4ChartsTabContent() {
  ...
  useEffect(() => {
    ...
    testImg.src = '/img/P401.png';
    testImg.onload = () => {
      setLoadingError(false);
    };
    testImg.onerror = () => {
      setLoadingError(true);
      toast.error("Could not load PICK4 chart images. Please check file paths and server configuration.", {
        description: "Make sure image files exist in the public/img directory with correct filenames (P401.png, P402.png, P403.png)."
      });
    };
  }, []);
      ...
      <Card className="p-4">
        ...
        {loadingError && (
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4" role="alert">
            ...
            <span className="block sm:inline"> Chart images could not be loaded. Please verify that the images exist in the public/img folder with the correct names (P401.png, P402.png, P403.png).</span>
          </div>
        )}
